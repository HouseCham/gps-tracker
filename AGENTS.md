Please read the current repo's documentation and understand it. The important data is located at:
...
As soon as you understand the context, ask the user what's the next step to build.